...
[[fikrirozan](https://fikrirozan.vercel.app/)]
...
```bash
git clone https://github.com/fikrirazor/personal-website.git
```
...
3. Add your own projects in `src/components/Portfolio.tsx`
4. Replace images in the `src/assets/` folder
