...
function Portfolio() {
  ...
  const allWorkItems = [
    ...
    {
      id: 3,
      title: "StoreApp PERN — E-Commerce Platform",
      description:
        "Lightweight e-commerce system with secure product management",
      category: "Full-Stack Development",
      yearRange: "2025",
      details: [
        "Developed product management with full CRUD operations",
        "Designed PostgreSQL schema deployed on NeonDB",
        "Implemented API security with CORS, Helmet & rate limiting",
        "Built responsive UI with React & TailwindCSS",
        "Created secure API middleware for data protection",
      ],
      image: "/api/placeholder/600/400",
      url: "#",
      tech: ["Express.js", "PostgreSQL", "React", "TailwindCSS", "NeonDB"],
    },
    {
      id: 4,
